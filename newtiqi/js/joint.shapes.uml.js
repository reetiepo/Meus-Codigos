...
joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
    ...
    markup: [
        '<defs>',
            '<linearGradient id="grad1" x1="0%" y1="5%" x2="0%" y2="100%">',
                '<stop offset="0%" style="stop-color:rgb(83,146,179);stop-opacity:1" />',
                '<stop offset="100%" style="stop-color:rgb(22,109,155);stop-opacity:1" />',
            '</linearGradient>',
        '</defs>',
        '<g class="rotatable">',
          '<g class="scalable">',
          ...
          '</g>',
          '<text class="uml-class-name-text"/>attricons<text class="uml-class-attrs-text"/>funcicons<text class="uml-class-methods-text"/>',
        '</g>'
    ].join(''),
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.uml-class-name-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': 'url(#grad1)' },
            '.uml-class-attrs-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': '#dff2fa' },
            '.uml-class-methods-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': '#f9f0b9' },

            '.uml-class-name-text': {
                'ref': '.uml-class-name-rect', 'ref-y': .5, 'ref-x': .5, 'text-anchor': 'middle', 'y-alignment': 'middle', 'font-weight': 'bold',
                'fill': 'white', 'font-size': 12, 'font-family': '"Tahoma", "Arial", "sans-serif"'
            },
            '.uml-class-attrs-text': {
                'ref': '.uml-class-attrs-rect', 'ref-y': 5, 'ref-x': 5,
                'fill': 'black', 'font-size': 12, 'font-family': '"Tahoma", "Arial", "sans-serif"'
            },
...
joint.shapes.uml.Line = joint.dia.Link.extend({
    defaults: {
        type: 'uml.Line',
        attrs: { '.marker-target': { fill: 'white' }}
    }
});
