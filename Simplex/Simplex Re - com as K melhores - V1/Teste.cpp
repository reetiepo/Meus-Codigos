...
//						
//						//Dados para o relatório
//						if(TamanhoRetalhoPadrao(matriz,n,qtdTiposItem,dados,totalItensDiscretizados) || leftover == n)
//						{
//							if(leftover == n)
//							{
...
//								total_sobra += vetsol[n]*TamanhoRetalhoPadrao(matriz,n,qtdTiposItem,dados,totalItensDiscretizados);
//								//obj_com_sobra += vetsol[n];
//
//								//perda_total += vetsol[n]*loss - (vetsol[n]*TamanhoRetalhoPadrao(matsol,n,qtdTiposItem,size_item,totalItensDiscretizados)); 
//								total_perda += vetsol[n]*loss - (vetsol[n]*TamanhoRetalhoPadrao(matriz,n,qtdTiposItem,dados,totalItensDiscretizados)); 
//							}
//						}
//						else
//						{
